...
async function autoInicioProducts() {
    ...
    try {
        const url = 'http://144.22.238.58:8080/api/chocolate/all'
        // console.log(url)
...
async function consultarProduct(price, reference) {
    ...
    try {
        ...
        // debugger
        const url = 'http://144.22.238.58:8080/api/chocolate/' + reference
        // console.log(url)
        const response = await fetch(url);
    ...
    if ($("#reference").val().length == 0 ||
       // $("#brand").val().length == 0 ||
        ...
        try {
            //debugger
            let availability;
            const urlUpdate = 'http://144.22.238.58:8080/api/chocolate/new'
    ...
    if ($("#referenceU").val().length == 0 ||
       ...
       // $("#materialU").val().length == 0 ||
        ...
        try {
            ...
            const urlUpdate = 'http://144.22.238.58:8080/api/chocolate/update'
...
async function deleteProduct(price, reference) {
    ...
    try {
        ...
        const urlUpdate = 'http://144.22.238.58:8080/api/chocolate/' + reference
